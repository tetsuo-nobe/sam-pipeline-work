...
1. [**スタック**] から `sam-stack-(自分のID)` のラジオボタンを選択します。
...
1. S3 のページで `aws-sam-cli-managed-default` で始まるバケットのラジオボタンを選択して [**空にする**] を選択してすべてのオブジェクトを削除します。 
